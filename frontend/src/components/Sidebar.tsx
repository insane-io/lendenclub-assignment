      ...
      <div>
        ...
        <div className="space-y-6">
          <div className="bg-white p-4 py-8 rounded-xl shadow-sm border border-blue-100">
            ...
            <h2 className="text-5xl font-bold text-gray-900">₹ {userDetails?.balance}</h2>
          </div>
          ...
          <div className="space-y-2">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `w-full flex items-center space-x-3 p-3 rounded-lg transition ${isActive ? 'bg-blue-100 text-blue-700' : 'hover:bg-gray-100 text-gray-600'}`
              }
            >
